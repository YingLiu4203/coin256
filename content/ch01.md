...
在美国法律体系里，第三方原则是指用户使用第三方服务（如 YouTube、Facebook）而产生的非内容信息不享有“合理的隐私期待”。内容信息是指通信或文件的内容，而非内容型信息是相关的业务记录数据，例如账号注册资料、IP 与登录日志、追踪/订阅、点赞与分享的记录、广告与设备标识等，这些信息不属于合理隐私期待范畴。这一原则源自两宗美国最高法院对美国宪法第四修正案解释的判例。其一是 1976 年美国诉米勒案：最高法院裁定，银行客户对其提供给银行的支票和交易记录不享有合理的隐私期待。另一个则是 1979 年史密斯诉马里兰州案：法院裁定，个人对其拨打的电话号码不享有隐私期待，因为他们自愿将该信息暴露给了电话公司。

多数用户在注册互联网服务时，不会仔细阅读就同意其服务条款。其实很多时候也没有选择，因为不同意这些条款就无法使用其服务。许多服务条款中明确规定了用户的数据将如何被收集、存储和使用（通常用于定向广告）。这些条款进一步削弱了用户隐私。
...
实际运作层面，信息服务提供者也会面临政府方面的压力而关闭特定用户的服务。2025 年 9 月 23 日 Alphabet 公司的（Google/YouTube 母公司）律师给美国众院司法委员会的函件描述了这种情况。信中称，拜登政府多名官员（含白宫）在疫情期间反复且持续联系并施压Alphabet，就某些并未违反平台规则的 COVID-19 内容要求采取行动。Alphabet在信里称，任何政府试图主导内容审核都“不可接受且错误”。与此同时，YouTube宣布给因已废止的“选举完整性”和“疫情错误资讯”规则而被永久封禁的频道一个回归机会。
...
二十一世纪的人类拥有前所未有的技术能力，但也陷入了前所未有的危机之中：从日益恶化的生态危机到可以短时间毁灭人类的大量末日武器，现在又新添了人工智慧 AI 这种有可能发展失控的新危机。可以理解智商 150 的人类对可能智商 1500 的未来 AI 的担心，但本书更加关注正在现实发生的事情：平台化企业与数字政府在算法与 AI 的驱动下展现出惊人的组织能力。计算机执行标准流程一丝不苟、效率极高，能并行处理海量数据，永不忘记且从不间断。在制度视角里，这样的硅基官僚简直是理想工具。它稳定、可复制、可度量，可以把个人的一举一动都转化成可实时处理的数据，能把流程压缩到近乎零误差，把成本摊薄到极致。这样的系统随处可见而且在不断进化之中：短视频与资讯平台用上千个特征实时评估每条内容的“点击率预期”，在毫秒内决定分发给哪一批用户并立刻做调整；银行风控引擎在几百毫秒内读取上百项征信与设备指纹，完成贷款预审批并给出差异化利率；城市治理中，车牌识别与电子围栏自动生成罚单与拥堵费，连夜批量处理上百万条记录；税务与医保稽核把所有发票与报销单据做图像与结构化比对，按异常分值自动触发复审；疫情期间，健康码/通行码系统将个人出行管理、场所准入与通行许可嵌入同一算法管道，实现全城细化到个人级别的实时管控。这些场景让“标准化、自动化、规模化”的优势具象可见，也解释了为何集中式系统对机构而言如此具有吸引力。

### 5.1 三类风险

但效率不等于稳健。集中化把复杂世界压缩为少数中枢，也把风险浓缩为单点失效与系统性误配。一旦目标函数设错、数据偏差进入、或关键环节被攻破，错误就会沿着统一管道被高速放大、自动执行。当官僚体制的流程固化与 AI 的目标优化耦合，二者相互强化，形成“流程越来越自动、决策越来越黑箱、纠错越来越迟缓”的结构性倾向。这样的集中化系统可能造成三类风险的叠加。

首先是目标优化风险。集中系统依赖可量化指标代理复杂的现实，而现实总比指标更复杂而去一直处于变化之中。古德哈特定律（Goodhart's Law）指出“一旦某个衡量指标被用作目标，它就不再是一个好的指标。”。为指标而优化在高性能 AI 的加持下更具破坏力，偏差不再是问题，而会被制度化地执行。如果当学校用升学率、平均分考核，课堂会滑向“刷题工业化”。若再叠加 AI 排课与教学评估，模型会倾向把资源投给最能加分的学生与题型，学习被等同于提分，批判性思维与创造力被边缘化。指标好看，但是会降低学生的学习兴趣与创造力这种不容易衡量的关键特性。生活中更加常见的是短视频与资讯流把点击率、完播率设为目标，推荐系统便源源不断地推送更极端、更情绪化的内容来抓注意力。引入强化学习或大模型生成内容后，系统学会精准投喂，信息质量与公共理性被牺牲，但指标飙升。在金融领域，为降低坏账率，模型学会拒绝边缘人群。当 AI 风控覆盖更广，统计上的稳健演化为制度化的排斥，信贷获取更不平等。但这些真实的资金需求并不会消失，而是溢出到监管更弱、信息更不透明的灰色/影子借贷渠道（如高息互联网小贷、导流平台、民间借贷、套路贷等）。随之而来，成本、风险与不良后果也从正式体系转移到灰色地带。整体风险也可能因灰色借贷外溢而上升。

其次是治理风险。算法管道化决策模糊了问责链。当模型被嵌入规章，纠偏的成本急剧上升，技术与制度的路径依赖让错误固化为默认。比如在社交平台。算法一键识别可疑内容并下架，创作者被要求先自证清白。平台以体量太大，只能自动化为由，把责任外推给算法与权利人。申诉链路漫长且不透明。默认是算法对，内容先消失，错杀信息的外部性由创作者与公众承担。同样的情况发生在医疗保险行业，当系统给出统一可报销项目清单和住院天数上限。医生需大量文书才能越过阈值，患者默认被拒。前线办事员只执行系统允许的功能，承包商说按合同交付模型，主管机关称模型依据法规。此时问责链被切碎，没有人对单个错判负责，要推翻默的流程，需要层层批复与漫长申诉。规章一旦写进模型，错判就成了制度化默认，纠偏的社会与政治成本极高。

第三个也可能是最大的风险是系统性安全风险。少数巨大而同质的中枢是最佳攻击面与最脆弱断点。相比无数小而异质的独立个人系统，巨型集中系统一旦出错，级联失败更广、更深、更难以恢复。比如 2018 年 6 月 1 日下午，Visa 在欧洲的授权系统发生大面积故障，商户刷卡与线上支付大范围受阻。不少零售商被迫转为“只收现金”，英国部分地区 ATM 在短时间内出现现金告急，这一连锁效应很快暴露出高度集中支付网络的脆弱性。商户收款、现金补给、线上结算彼此耦合，一次授权障碍会迅速传导为消费停滞与现金挤兑式提取。2021 年 10 月 4 日，一次例行维护中对骨干网络的配置命令误将 Meta 全球数据中心彼此断开，随之触发互联网路由撤销，结果就是 Meta 旗下的 Facebook、Instagram、WhatsApp、Oculus 等服务下线，同时用户也无法登录大量用 Facebook 登录的第三方网站。长达数个小时，社交、消息、身份登录以及一些商业交易都处于中断状态。

### 5.2 真实例子

一个有代表性的例子可能是发生于 2023 年 1 月 11 日清晨的全美国停飞事故。当时美国联邦航空管理局（FAA）用于向飞行员与签派员发布跑道关闭、空域限制、导航台故障等关键信息的计算机系统突发故障。前一晚在主备数据库同步过程中，操作人人员误删并损坏了关键文件，且错误数据被同步污染到备用系统，导致计划中的自动切换失效。为避免在无法确认近端安全通告的情况下继续放行航班，FAA 于美东时间 7:30 下达全国范围的地面停飞令（空中航班继续落地），直至 9:07 才陆续解除。但连锁反应贯穿整日，累计造成近万次航班延误、逾千次取消。问题的根本原因竟然是一个小小的文件误删。

迄今最危险的计算机系统事故发生 1983 年 9 月 26 日。当晚莫斯科近郊谢尔普霍夫-15 号预警中心的苏联早期预警卫星系统突然报警美国发射了一枚洲际导弹，几秒后又显示再发射四枚。按条令，值班军官应立即上报，进入核反击决策链。但当班的苏军中校判断不对劲，来袭导弹数量太少，地面雷达也未见到达证据，更像是系统错报而非真实先发制人。他顶住压力，将其判定为误报，冒着违反程序的风险选择了暂不升级。事后调查显示，卫星红外传感器把高空云层反射的阳光误当作导弹尾焰，算法触发了假阳性。当时处于苏军刚击落大韩航空 007 号客机，美苏关系高度紧张的历史时刻，彼得罗夫的冷静让世界从核边缘退了一步，一桩传感器与判据的微小错误和算法的错误，差点点燃人类最后一场战争。如果当时做决策的是完全按照既定算法运行的 AI 系统，则人类的全部希望或许早已不在了。

造成巨大人道灾难的一个例子发生于 2016–2018 年间的缅甸。当时 Facebook 在全球不断强化停留时长与互动率导向的推荐逻辑。内部文档显示，平台一度为能引发愤怒反应的内容赋予更高的分发权重，因为这类帖子更能让用户停留、更爱互动。但副作用是更极端、更煽动的内容更容易被推上用户首页。在缅甸，这套机制被接上了高度紧张的现实。大多数佛教徒与若开邦的罗兴亚穆斯林之间的冲突，被民族主义者与军方舆论机器利用，仇恨与谣言借助平台以缅文扩散。鼓吹仇恨的极端僧侣阿欣·维拉图（Ashin Wirathu）的言论被平台推荐到大范围的用户以增加观看时长。路透社当年的大篇幅调查也显示，平台上长期充斥上千条针对罗兴亚人的煽动与假消息，而内容审核在缅文语境下严重人手不足、响应迟缓。联合国独立事实调查团在 2018 年向人权理事会报告称，Facebook 在煽动对罗兴亚人的仇恨与暴力中发挥了“决定性”作用。稍后 Facebook 承认在缅甸行动太慢并封禁了维拉图的账号。但为时已晚，后果是血淋淋的。无国界医生（MSF）基于难民营调查估算，仅 2017 年 8 月 25 日后一个月，就有至少 6,700 名罗兴亚人死于暴力。到 2018 年初，超过 70 万人被迫逃往孟加拉国。 在这场信息洪水里，更能激起情绪、让人看更久的算法偏好，与实际生活中的民族主义动员相互放大，视频与贴文不断被推送到更多缅甸用户眼前，谣言被反复“看见”后就像事实。而被点名的少数群体，在现实世界里付出了焚村、流离与死亡的代价。

叙述这些真实例子不是对技术的悲观，而是对制度与结构的警惕。在现实激励与博弈里，硅基官僚几乎是必然产物。企业在赢家通吃的网络效应与季度财报的双重压力下，为了成本—效率—规模的边际优势，天然会把判断外包给永不疲劳、可复制扩张的算法流程。国家在产业竞赛与地缘对抗中，为了治理能力、情报优势与舆论塑形，同样会加码数据集中与自动化决策。短视与贪婪把这一切推向看得见的数字胜过看不见的价值的古德哈特轨道：指标即目标，黑箱即规章。机构参与者在各自局部都理性（追逐份额、关键性能指标、可控性与安全），却在总体上形成军备竞赛与逐底竞争，把组织从可争辩的判断滑向不可见的参数治理，并在规模报酬递增与路径依赖中锁定。当企业间与国家之间的竞争同时加速这条轨道，监管滞后与外部性扩散又抬高转向成本，工具变制度的门槛愈发低、回头路愈发窄。除非以结构性约束（分层自治、异构冗余、人工复核与否决权等）强行改变赛道，否则在人的短视与贪婪驱动下，硅基官僚从可能滑向日益可见的现实。当集中化的硅基官僚追求更大、更多、更优的控制时，人们更需要行动起来，利用信息技术为个体与社区重新定义权利的边界和保留自治空间。否则等到我们意识到“谁在驾车”时，留给人类的方向盘或许早已消失多时了。
...
[连结]: Harari, Y. N. (2024). Nexus: a brief history of information networks from the Stone Age to AI. First U.S. edition. Random House.
