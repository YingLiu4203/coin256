...
今天我们也处在一个类似的时刻。信息技术的指数发展和密码学的突破让数千年来人类苦苦追寻的信息自由与财产自由变得实际可行。2019年开始运行的比特币以不过数千行的核心代码起航，十余年间成长为万亿级的全球价值网络。它用公开源代码、密码学签名与去中心化共识，把货币的所有权与支配权直接交还给个体。这是人类历史上首次个人在技术层面拥有了无需许可的安全的主权货币。而要达到进一步的信息自由，所需的技术基础都已就绪，要做的不过是发明一些新的通信协议，创造一个基于个人信任网（Web of Trust）的主权个人互联网 (SovinWeb： Sovereign Individual Web)。
